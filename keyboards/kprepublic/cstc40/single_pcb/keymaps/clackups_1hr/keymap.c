 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |  1   |   2  |   3  | Tab  |   N  |   M  |   ,  |  .   |   /  |   \  |  Up  | Left |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | WIN  |  0   | Space| Space| Space|    Space    |  Alt |Ctrl  | Shift| Down |Right |
 * `-----------------------------------------------------------------------------------'
 */
[0] = LAYOUT_planck_mit(
    KC_7,        KC_8,      KC_9,  KC_TILD,    KC_Y,    KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC, KC_RBRC, KC_BSPC,
    KC_4,        KC_5,      KC_6,  KC_ESC,     KC_H,    KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT, KC_ENT,  KC_ENT,
    KC_1,        KC_2,      KC_3,  KC_TAB,     KC_N,    KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_BSLS, KC_UP,   KC_LEFT,
    KC_LWIN,     KC_0, LT(1,KC_SPC),LT(1,KC_SPC), LT(1,KC_SPC), LT(1,KC_SPC),OSM(MOD_RALT), OSM(MOD_RCTL), OSM(MOD_RSFT),  KC_DOWN, KC_RGHT
),
...
[1] = LAYOUT_planck_mit(
    ...
    KC_F1,       KC_F2,       KC_F3,   XXXXXXX,  KC_B,    KC_V,     KC_C,     KC_X,     KC_Z,     KC_NUBS, KC_PGUP, XXXXXXX,
