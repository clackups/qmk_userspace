...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT_all(
        ...
        OSM(MOD_LSFT), KC_NUBS, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,      OSM(MOD_RSFT), KC_UP,   KC_DEL,
	...
	[1] = LAYOUT_all(
        ...
        XXXXXXX, UG_TOGG, UG_NEXT, UG_HUED, UG_HUEU, UG_SATD, UG_SATU, UG_VALD, UG_VALU, XXXXXXX, KC_PSCR, KC_SCRL, KC_PAUS,  KC_GRV,
        XXXXXXX, BL_TOGG, BL_DOWN,  BL_UP,  BL_BRTG, XXXXXXX, XXXXXXX, XXXXXXX, KC_MPRV, KC_MPLY, KC_MNXT, XXXXXXX, XXXXXXX, XXXXXXX,
	...
	[2] = LAYOUT_all(
        XXXXXXX,          KC_0,    KC_9,    KC_8,    KC_7,    KC_6,    KC_5,    KC_4,    KC_3,    KC_2,    KC_1,    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
        XXXXXXX,          KC_P,    KC_O,    KC_I,    KC_U,    KC_Y,    KC_T,    KC_R,    KC_E,    KC_W,    KC_Q,    XXXXXXX, XXXXXXX, XXXXXXX,
        XXXXXXX,          KC_SCLN, KC_L,    KC_K,    KC_J,    KC_H,    KC_G,    KC_F,    KC_D,    KC_S,    KC_A,    XXXXXXX, XXXXXXX, XXXXXXX,
